...
const { getNotifications, markRead, getAllUserNotifications } = require('../controllers/notificationController');
 ...
 * /notifications:
 *   get:
 *     summary: Get all notifications for all greenhouses of the current user
 *     tags:
 *       - Notifications
 *     security:
 *       - bearerAuth: []
 ...
 *         schema:
 *           type: integer
 *         description: Number of notifications to fetch (default 50)
 *     responses:
 *       200:
